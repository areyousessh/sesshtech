            ...
            <span className="flex border-t-2 mt-20 mb-28 w-96 justify-center border-orange-100 " />
                ...
                <div className="flex">
                    <a href="https://github.com/areyousessh">
                        <img src="../src/assets/Octocat.png" alt="github octocat logo" className="w-16 h-16" />
                    </a>
                ...
                <div className="flex">
                    <a href="https://www.linkedin.com/in/gustavo-alves-7a57a7122/">
                        <img src="../src/assets/inlogo.png" alt="Linkeding logo" className="w-16 h-12 mt-12 ml-24" />
                    </a>
                        <span className="text-white-200 mt-16 font-semibold">/gustavo-alves-7a57a7122</span>
                </div>
                <div className="flex">
                    <a href="mailto:gusalves@sessh.tech">
                        <img src="../src/assets/mail.png" alt="Mail logo" className="w-20 h-14 mt-12 ml-24 " />
                    </a>
